...
são os polos), iterámos sobre os valores de \( \theta \), determinámos a altura \( y \) do ponto
...
triângulo com o pólo norte e o ponto seguinte na mesma stack. Para garantir continuidade circular,
o último ponto da stack liga-se novamente ao primeiro, ou seja, os vértices são ligados de forma a
criar \textbf{duas faces triangulares por célula}:
\[
T_1 = (P_1, P_3, P_2)
\]
