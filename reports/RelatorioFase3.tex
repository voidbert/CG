...
A translação dinâmica é muito diferente da translação estática. Nesta translação
dinâmica guardamos o tempo de execução como já referido anteriormente, um booleano
chamado align que nos indica se o objeto está alinhado com a curva, os pontos da
curva e um Line.

O Line é usado para desenharmos a linha de movimento Catmull-Rom.
...
\subsubsection{Linhas Catmull-Rom}

No nosso programa, podemos tanto visualizar as linhas de movimento Catmull-Rom (default)
