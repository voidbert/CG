...
texturas e materiais. A aplicação de luzes adequadas valorizou os planetas, destacando suas formas
e posições no espaço, enquanto as texturas acrescentaram detalhes visuais como relevos, cores e
superfícies características de cada corpo celeste. A introdução de materiais contribuiu para simular
características físicas dos planetas, como brilho e reflexos, enriquecendo ainda mais a cena. Esses
elementos contribuíram para uma representação mais fiel e envolvente do sistema solar, aumentando
consideravelmente o realismo da cena e proporcionando uma experiência visual mais imersiva.
